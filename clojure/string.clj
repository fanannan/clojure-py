...
(defn replace
  ...
  If match is a regular expression then replacement can be either a string or a
  function. If replacement is a function, it is called for every non-overlapping
  occurrence of pattern.

  See also replace-first."
  [s match replacement]
  (re/sub match replacement s))
